...
REM 配置区域
REM ============================================
@REM set "SOURCE_PATH=E:\tool\win_rar_auto\test\game_src"
set "SOURCE_PATH=E:\game\SLG\ 0101\2\荒诞\pc\pc
set "WINRAR_PATH=D:\apple\software\WinRAR.exe"
set "DEST_PATH=E:\game\SLG\ 0101\cursor_do_2"

REM 解压密码列表（按顺序尝试，空密码表示无密码）
set "PASSWORD1="
...
if exist "*.zip" set "has_archive=1"
